...
def main():
    ...
    ap.add_argument("--roi_x", default=128, type=int, help="roi size in x direction")
    ap.add_argument("--roi_y", default=128, type=int, help="roi size in y direction")
    ap.add_argument("--roi_z", default=128, type=int, help="roi size in z direction")
