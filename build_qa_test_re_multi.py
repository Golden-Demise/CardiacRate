...
def main():
    ...
    for i in range(1,101):
        fact_path = f"D://CardiacRate//dataset//facts3//patient{i:04d}_facts.json"
        ...
        out_path = f"D://CardiacRate//dataset//generated_qa//test//patient{i:04d}_facts.json"
        save_json(result, out_path)
        print(f"[OK] Generated QA saved to: {out_path}")
